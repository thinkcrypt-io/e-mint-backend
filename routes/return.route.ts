...
import Return, { returnSettings as settings } from '../models/return/saleReturn.model.js';
import adjustReturn from '../controllers/inventory/adjustReturn.controller.js';
...
router
	...
	.post(...postMiddleware, adjustReturn);
