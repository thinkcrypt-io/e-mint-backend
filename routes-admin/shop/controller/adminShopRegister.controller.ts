...
const adminShopRegister = async (req: any, res: Response): Promise<Response> => {
	...
	try {
		const { name, email, password, shopName, phone, package: sub } = req.body;
...
export default adminShopRegister;
